...
<template>
  ...
  >
    ...
    >
      <ul
        class="flex items-center justify-end text-xs text-[#333333] font-light px-2
          h-10 bg-[#FAFAFA] max-w-[1200px]"
      >
        <li
          class="border-r border-r-gray-400 px-3 hover:text-[#FF4646] cursor-pointer"
        >
          Sell on Kurosawa's Project
        </li>
        <li
          class="border-r border-r-gray-400 px-3 hover:text-[#FF4646] cursor-pointer"
        >
    ...
    >
      ...
      >
        ...
        >
          ...
          />
          <!-- <Icon name="game-icons:death-zone" size="20" /> -->
        </NuxtLink>
